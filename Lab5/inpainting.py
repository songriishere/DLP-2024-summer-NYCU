    ...
    def inpainting(self,image,mask_b,i): #MakGIT inference
        ...
        with torch.no_grad():
            ...
            for step in range(self.total_iter):
                ...
                z_indices_predict, mask_bc = self.model.inpainting(self.mask_func , ratio , mask_num , z_indices_predict , mask_bc)
...
#TODO3 step1-2: modify the path, MVTM parameters
    parser.add_argument('--load-transformer-ckpt-path', type=str, default='./transformer_cp/best_val.pth', help='load ckpt')
    #dataset path
